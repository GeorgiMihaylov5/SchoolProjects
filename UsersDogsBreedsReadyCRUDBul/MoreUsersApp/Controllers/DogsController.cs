...
namespace MoreUsersApp.Controllers
{
    public class DogsController : Controller
    {
        ...
        public ActionResult SearchDogs()
        {
        ...
        [HttpPost]
        public ActionResult SearchDogs(int age)
        {
        ...
        {
            var dogStatistic = new DogStatisticVM()
            {
                DogsCount = _dogService.GetDogs().Count()
            };

            return View(dogStatistic);
        }
        [Authorize]
        public IActionResult SearchByBreed(int id)
        {
            List<DogListVM> dogsFromDb = _dogService.GetDogs()
            ...
            return View("SearchDogs", dogsFromDb);
        }
